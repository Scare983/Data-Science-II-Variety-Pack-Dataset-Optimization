...
# Utility method
def graphAttsVRVals(rsq, rCv, rbar, numParams, item,  modelParams, columnName, fName):
    ...
    if fName == 'boston':
        prepend = 'Boston'
    elif fName == 'qsar_aquatic_toxicity':
        prepend = 'Aqua'
    elif fName == 'fifa_player_data':
        prepend = 'Fifa'
    else:
        prepend = 'Mpg'


    plt.savefig("./{}/AllResults/Images/{}{}{}Epochs{}Eta{}Y{}.jpg".format(prepend,item, modelParams['model'], modelParams['activation'], modelParams['epochs'], modelParams['lr'], columnName))
    plt.clf()
